...
export class RadioGroup implements AfterContentInit, ControlValueAccessor {
  ...
  private _name: string = `gg-radio-group-${uniqueId++}`;
...
export class RadioButton implements AfterViewInit, OnInit, OnDestroy {
  ...
  private _id: string = `gg-radio-button-${uniqueId++}`;
